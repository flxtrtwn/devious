...
def test_wait_for_process() -> None:
    ...
    with pytest.raises(ValueError):
        with processing.wait_for_callable(callable_raising_exception):
            pass
...
def test_temp_env() -> None:
    ...
    with processing.temp_env(test="test_variable"):
    ...
    with processing.temp_env(all_caps=True, test="test_variable"):
        assert os.environ.get("TEST") == "test_variable"
